            ...
            <div className="bg-brand-blue">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    ...
                    <div className="flex-1 max-w-2xl mx-4 flex items-center gap-2 relative">
                        ...
                        <button
                            onClick={onAiFinderClick}
                            className="bg-brand-accent text-white px-4 py-2.5 rounded-md hover:bg-purple-700 hover:scale-105 active:scale-95 transition-all hidden md:flex items-center gap-2"
                        >
                            <AIIcon className="w-5 h-5" />
                            <span className="font-semibold text-sm">AI Finder</span>
                        </button>
                    </div>
